            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                      ...
                      let txt = `「 PISSU KOLAMA & PISSU KOLLAH HERE」\n\n${text}`
...
Pissu Kollah ( Sohan)
Pissu Kolama (Queen...) 🐦 Who Helped Assemble This  Script !!!`,unicorn, [{"urlButton": {"displayText": "YouTube","url": `${myweb}`}},{"urlButton": {"displayText": "Script","url": `${sc}`}},{"quickReplyButton": {"displayText": "Donate","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
